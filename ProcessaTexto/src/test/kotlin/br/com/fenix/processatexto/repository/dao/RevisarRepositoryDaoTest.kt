...
abstract class RevisarRepositoryDaoTest(var conexao: Conexao, repository : RepositoryDao<UUID?, Revisar>) : RepositoryTestBaseDao<UUID?, Revisar>() {

    @InjectMocks
    override var repository: RepositoryDao<UUID?, Revisar> = repository
    ...
    fun testSetIsMangNovel() {
        ...
        val entity = (repository as RevisarDao).select(lastId!!)
    ...
    @Test
    @Order(14)
    fun testSelectSimilar() {
        val entity = (repository as RevisarDao).selectSimilar(lastEntity.vocabulario, lastEntity.ingles)
    ...
    fun testDelete() {
        ...
        val vocabulario = (repository as RevisarDao).select(lastEntity.vocabulario)
