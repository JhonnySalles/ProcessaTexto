...
public class EstatisticaController implements Initializable {
    ...
    private final List<List<Estatistica>> listaPalavra = new ArrayList<List<Estatistica>>();
    private final List<Tabela> combinacoes = new ArrayList<>();
    ...
    public static class Tabela {
        ...
        private final List<Estatistica> estatistica = new ArrayList<>();
