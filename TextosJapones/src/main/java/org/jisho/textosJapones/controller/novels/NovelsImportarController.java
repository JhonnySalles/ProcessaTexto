...
public class NovelsImportarController implements Initializable, BaseController {

    private static final Logger LOGGER = LoggerFactory.getLogger(NovelsImportarController.class);
    ...
    public static URL getFxmlLocate() {
        return NovelsImportarController.class.getResource("/view/novels/NovelImportar.fxml");
    }
}
