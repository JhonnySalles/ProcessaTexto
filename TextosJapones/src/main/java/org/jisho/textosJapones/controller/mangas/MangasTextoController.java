...
public class MangasTextoController implements Initializable, VinculoTextoListener {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MangasTextoController.class);
    ...
    private final InvalidationListener listenerMangaOriginal = observable -> {
    ...
    private final InvalidationListener listenerMangaVinculado = observable -> {
