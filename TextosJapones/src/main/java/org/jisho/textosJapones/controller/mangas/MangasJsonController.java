...
public class MangasJsonController implements Initializable {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MangasJsonController.class);
    ...
    private final VincularServices serviceVinculo = new VincularServices();
    ...
    private final String patern = ".*\\.(zip|cbz|rar|cbr|tar)$";
                ...
                try {
                    ...
                    ExclusionStrategy removeLinguagemCapitulo = new ExclusionStrategy() {
                        ...
                        public boolean shouldSkipField(FieldAttributes field) {
                            ...
                            return field.getDeclaringClass() == MangaCapitulo.class && field.getName().equals("volume");
                        }
