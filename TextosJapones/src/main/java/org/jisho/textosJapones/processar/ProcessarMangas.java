...
public class ProcessarMangas {
	...
	private RevisarJaponesServices serviceJaponesRevisar = new RevisarJaponesServices();
	private RevisarInglesServices serviceInglesRevisar = new RevisarInglesServices();
