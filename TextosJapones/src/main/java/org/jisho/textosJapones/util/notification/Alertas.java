...
public class Alertas {
	...
	public final static ImageView ALERTA = new ImageView(
			new Image(Alertas.class.getResourceAsStream("/org/jisho/textosJapones/resources/images/alert/icoAlerta_48.png")));
	public final static ImageView AVISO = new ImageView(
			new Image(Alertas.class.getResourceAsStream("/org/jisho/textosJapones/resources/images/alert/icoAviso_48.png")));
	public final static ImageView ERRO = new ImageView(
			new Image(Alertas.class.getResourceAsStream("/org/jisho/textosJapones/resources/images/alert/icoErro_48.png")));
	public final static ImageView CONFIRMA = new ImageView(
			new Image(Alertas.class.getResourceAsStream("/org/jisho/textosJapones/resources/images/alert/icoConfirma_48.png")));

	public final static String CSS = Alertas.class.getResource("/org/jisho/textosJapones/resources/css/Dark_Alerts.css")
			.toExternalForm();
	...
	public static void setRootStackPane(StackPane rootStackPane) {
		Alertas.ROOT_STACK_PANE = rootStackPane;
	}
	...
	public static void dialogLogin(StackPane rootStackPane, Node nodeBlur, String titulo, String texto) {
		...
		dialog.getStylesheets().add(
				Alertas.class.getResource("/org/jisho/textosJapones/resources/css/Dark_Alerts.css").toExternalForm());
	...
	public static void showTrayMessage(String title, String message) {
		try {
			...
			BufferedImage image = ImageIO.read(Alertas.class.getResource(CAMINHO_ICONE));
