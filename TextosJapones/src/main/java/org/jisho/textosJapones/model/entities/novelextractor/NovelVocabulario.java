...
public class NovelVocabulario {
	...
	public NovelVocabulario(String palavra, String portugues) {
		this.id = null;
		this.palavra = palavra;
		this.portugues = portugues;
		this.ingles = "";
	...
	public NovelVocabulario(String palavra, String portugues, String ingles, String leitura) {
		this.id = null;
		this.palavra = palavra;
		this.portugues = portugues;
		this.ingles = ingles;
	...
	public NovelVocabulario(String palavra, String portugues, String ingles, String leitura, Boolean revisado) {
		this.id = null;
		this.palavra = palavra;
		this.portugues = portugues;
		this.ingles = ingles;
	...
	public NovelVocabulario(UUID id, String palavra, String portugues, String ingles, String leitura, Boolean revisado) {
		this.id = id;
		this.palavra = palavra;
		this.portugues = portugues;
		this.ingles = ingles;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NovelVocabulario other = (NovelVocabulario) obj;
		if (ingles == null) {
